...
pub const Probe = extern struct {
    last_op: u8 = 0, // last opcode supported
...
pub const CqePadding = extern union {
    no_padding: void,
    with_padding: [2]u64,
};
...
pub const Cqe = extern struct {
    user_data: u64 = 0, // sqe->data submission passed back
    ...
    flags: CqeFlags = .{},
    padding: CqePadding = mem.zeroes(CqePadding),
};
